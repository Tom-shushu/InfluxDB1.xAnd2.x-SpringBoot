...
import com.example.influxdb.influx.utils.InfluxUtil;
...
public class InfluxServiceImpl implements InfluxService {
    ...
    public Object queryAll(InsertParams insertParams) {
        ...
        System.err.println(queryResult.getResults().get(0).getSeries().get(0).getValues().get(0).get(0));
        System.err.println(queryResult.getResults().get(0).getSeries().get(0).getValues().get(0).get(1));
